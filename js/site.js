...
(function () {
    ...
    if ('IntersectionObserver' in window && !reduce) {
        var sel = '.section-label, .section-title, .section-intro, .step, .board-item, .board-value, .conversation-exchange, .testimonial, .pricing-card, .pilot-description, .about-block, .lead-prose, .compare, .pull-quote, .scope-item, .value-maths, .pillar, .trap-list, .trap-close, .timeline-step, .timeline-close, .hero-content > *';
